...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public void onBackPressed() {
        // If the pet has not changed, continue with handling back button press
        if (!mPetHasChanged) {
            super.onBackPressed();
            return;
        }
    ...
    private void showUnsavedChangesDialog(DialogInterface.OnClickListener discardButtonClickListener) {
        ...
        builder.setNegativeButton(R.string.keep_editing, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int i) {
                //User clicked the keep editing button, so dismiss the
                //dialog box and continue editing the pet.
                if (dialog != null) {
                    dialog.dismiss();
                }
            }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        //Update the input (textboxes and spinner) with the pet data.
        //Move the cursor to the zero position before extracting out column values
